...
/**
 *
 * A* implementation. Extends the Search abstract class. Uses PriorityQueues to represent the Frontier.
 *
...
public class AStar extends InformedSearch {
    ...
    /**
     * The main search method for the A* algorithm.
     *
    ...
    public ArrayList<Node> expand(Node node, Problem problem, PriorityQueue<Node> frontier, ArrayList<Node> exploredSet) {
        ...
        for (State state: nextStates) {
            // todo if state is in a node in frontier but with higher PATH-COST then replace old node with nd
